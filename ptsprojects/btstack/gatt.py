...
from ptsprojects.btstack.gatt_wid import gatt_wid_hdl
from ptsprojects.btstack.gattc_wid import gattc_wid_hdl
...
def main():
    """Main."""
    import ptsprojects.btstack.iutctl as iutctl
